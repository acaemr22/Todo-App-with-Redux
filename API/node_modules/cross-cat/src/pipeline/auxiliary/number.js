"use strict";
/*
    File: src/pipeline/auxiliary/number.ts
    cpuabuse.com
*/
...
function number(text, countBlank) {
    ...
    let displayNumber = 1;
    let firstLine = splitText.shift(); // Is never undefined because the text is never empty
    if (firstLine.length === 0 || treatCarriageReturnAsNotEmpty // Account for Windows line endings
        ? false
        : firstLine === "\r") {
        if (countBlank) {
    ...
    return splitText.reduce(function (previousResult, lineText) {
